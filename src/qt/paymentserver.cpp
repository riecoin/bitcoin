...
const char* BIP71_MIMETYPE_PAYMENT = "application/riecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/riecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/riecoin-paymentrequest";
