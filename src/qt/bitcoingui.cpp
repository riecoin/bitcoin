...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a riecoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Riecoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Riecoin"); // default title
