...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s riecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  riecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded riecoin transaction") + "\n" +
              "  riecoin-tx [options] -create [commands]   " + _("Create hex-encoded riecoin transaction") + "\n" +
              "\n";
